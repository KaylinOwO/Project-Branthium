...
inline static LPDIRECT3DDEVICE9 D3dDevice = NULL;
inline static LPDIRECT3DVERTEXBUFFER9 TriBuf = NULL;
...
void inline CreateOWindow()
{
	...
	Window = CreateWindowEx(NULL, "Spooler", "Spooler1", WS_POPUP | WS_VISIBLE, 0, 0, Width, Height, 0, 0, 0, 0);
...
inline void DrawStrokeText(float x, float y, const char* str)
{
	ImFont a;
...
inline void DrawText1(float x, float y, const char* str, RGBA* color)
{
	ImFont a;
	std::string utf_8_1 = std::string(str);
	std::string utf_8_2 = string_To_UTF8(utf_8_1);
...
inline void DrawLine(float x1, float y1, float x2, float y2, RGBA* color, float thickness)
{
...
inline void DrawCircle(float x, float y, float radius, RGBA* color, float segments)
{
	ImGui::GetOverlayDrawList()->AddCircle(ImVec2(x, y), radius, ImGui::ColorConvertFloat4ToU32(ImVec4(color->R / 255.0f, color->G / 255.0f, color->B / 255.0f, color->A / 255.0f)), (int)segments);
}
inline void DrawFilledCircle(float x, float y, float radius, RGBA* color, float segments)
{
...
inline void RectFilled(float x0, float y0, float x1, float y1, ImU32 color, float rounding, int rounding_corners_flags)
{
	ImGui::GetOverlayDrawList()->AddRectFilled(ImVec2(x0, y0), ImVec2(x1, y1), color, rounding, rounding_corners_flags);
}
inline void RectOutlined(float x0, float y0, float x1, float y1, ImU32 color, float rounding, int rounding_corners_flags)
{
